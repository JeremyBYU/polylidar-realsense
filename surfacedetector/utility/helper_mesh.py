...
try:
    ...
    print("Could not import organizedpointfilters")
    print("Will use very slow CPU only implementation")
    from polylidar import bilateral_filter_normals, laplacian_filter_vertices
    opf = None
